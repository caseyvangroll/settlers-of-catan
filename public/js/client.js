...
$(function () {
  ...
  //   sprite: PIXI.Sprite
  //   color: String (hex)
  //   resCards: ResourceCard[]
  //   devCards: DevelopmentCard[]
  //   settlements/cities: Colony[]
  //   roads: Road[]
  //   army: int
  //   self: boolean
  ;
  ...
  var extendResources = function extendResources() {
  ...
  var extendVertices = function extendVertices() {
  ...
  ;
  var loadGame = function loadGame(gamestate) {
  ...
  PIXI.loader.add('img/game-objects/resource.png').add('img/game-objects/vertex.png');
  ...
  var setState = function setState(state) {
    if (state === 'setup') {
      if (!mobile) {
        ...
        $('td.other div.name').each(function (index, other) {
          return other.append('Player ' + (index + 2));
        });
      } else {
